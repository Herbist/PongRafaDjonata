...
public class Player implements GameStateController {
    ...
    public void setPosBarra1(int posBarra1) {
        this.posBarra1 = posBarra1;
    }
    ...
    public void setPosBarra2(int posBarra2) {
        this.posBarra2 = posBarra2;
    }
    ...
    public void step(long l) {
         ...
         */
        if( (teclado.keyDown(Keyboard.W_KEY) == true) && (posBarra1 > 10) ) {
            posBarra1 -= 3;
        }
        if( (teclado.keyDown(Keyboard.S_KEY) == true) && (posBarra1 < (altura - 150) ) ) {
            posBarra1 += 3;
        }
